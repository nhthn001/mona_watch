    ...
    ?>
        <form action="modules/quanlysp/xuly.php?idsanpham=<?php echo $row['id_sanpham'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td><input type="text" value="<?php echo $row['giasp'] ?>" name="giaspold" ></td>
            </tr>
            <tr>
                <td>Giá sản phẩm (new)</td>
                <td><input type="text" value="<?php echo $row['giasp'] ?>" name="giaspnew" ></td>
            </tr>
            <tr>
                <td>Số lượng</td>
            ...
            <td>Danh mục sản phẩm</td>
                ...
                <td>
                    ...
                    <?php
                        if($row['tinhtrang'] == 1){
                    ?>
                        <option value="1" selcected>Kích hoạt</option>
